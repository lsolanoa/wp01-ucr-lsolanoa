<?php include 'includes/header.php'; ?>
  ...
  <div class="content-wrapper">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Importantes</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">Importantes</h3>
        </div>
        <div class="card-body p-0">
          <table class="table table-striped projects">
              ...
              <tbody>
                <?php
                  //Query Entries
                  $sql = "SELECT * FROM imp JOIN pages ON imp.id_page=pages.id_page ORDER BY id_imp";
                  $result = $db->query($sql);
                 ...
                 ?>
                  <tr>
                      ...
                      <td>
                        <span class="badge" style="background-color:<?php echo $row['color_imp']; ?>" title="Importante">Importante</span>
                        <i class="fas <?php echo $row['icon_imp'] ?>"></i>
                      </td>
                      <td class="project-actions text-right">
                        <form action="php/imp.php" method="post" >
    ...
    <select id="icons" class="form-control" name="icon_imp">
    <option value='fa-500px'>&#xf26e; fa-500px</option>
		...
		<option value='fa-youtube-square'>&#xf166; fa-youtube-square</option>
                      ...
                      <td>
                        ...
                        <td>
                          <input class="form-control" type="color" name="color_imp" value="">
                        </td>
                      <td class="project-actions text-right">
