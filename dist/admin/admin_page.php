    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">Página Recientes</h3>
          ...
          <table class="table table-striped projects">
              ...
              <tbody>
                  <tr>
                      ...
                      <td>
                        <span class="badge bg-success">[labels_page]</span>
                      </td>
                      <td>
                        [type_page]
                      </td>
                      <td class="project-actions text-right">
                        <form action="" method="post">
                          <button name="view" type="submit" class="btn btn-primary btn-sm" href="#">
                              <i class="fas fa-folder">
                              </i>
                              View
                          </button>
                          <button name="edit" type="submit" class="btn btn-info btn-sm" href="#">
                              <i class="fas fa-pencil-alt">
                              </i>
                              Edit
                          </button>
                          <button name="delete" type="submit" class="btn btn-danger btn-sm" href="#">
